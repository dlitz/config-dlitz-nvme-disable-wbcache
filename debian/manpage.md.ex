% config-dlitz-nvme-disable-wbcache(SECTION) | User Commands
%
% "October  8 2024"
...
config-dlitz-nvme-disable-wbcache - program to do something

# SYNOPSIS

**config-dlitz-nvme-disable-wbcache** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**config-dlitz-nvme-disable-wbcache** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **config-dlitz-nvme-disable-wbcache** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**config-dlitz-nvme-disable-wbcache** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    config-dlitz-nvme-disable-wbcache. See **foo.conf**(5) for further details.
...
**config-dlitz-nvme-disable-wbcache** provides some return codes, that can be used in scripts:
